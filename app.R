...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      textInput("Ed_device", "Ed_device", "Enter Ed device name here"),
      textInput("Lw_device", "Lw_device", "Enter Lw device name here"),
      fileInput("Rrs.file","Upload TRIOS Data"),
      textInput("outdir", "Output Directory", "Enter output directory path or leave blank for default"),
      textInput("Experiment","Experiment Name","Enter Experiment name in SeaBASS database"),
      textInput("Cruise", "Cruise Name","Enter Cruise name in SeaBASS database"),
      textInput("Station","Station", "Station Name or ID"),
      ...
      textInput("Comments", "Comments", "Any additional comments"),
...
server <- function(input, output, session) {
  ...
  # read.TRIOS data function. It reads raw TRIOS file and returns a list of
  ...
  # Render the data table after the plots
  ...
  # Main UI content, dynamically rendered
